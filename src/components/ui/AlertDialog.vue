        ...
        <div class="relative z-10 p-8 md:p-10">
          ...
          <div class="flex flex-col items-center mb-8">
            ...
            <div 
              ...
              class="w-16 h-16 rounded-full bg-gradient-to-br from-red-500/20 to-red-600/10 flex items-center justify-center border border-red-500/30 mb-4"
            >
            ...
            <div 
              v-else-if="confirmVariant === 'warning'"
              class="w-16 h-16 rounded-full bg-gradient-to-br from-[#e78a53]/20 to-[#f59a63]/10 flex items-center justify-center border border-[#e78a53]/30 mb-4"
            >
              <svg class="w-8 h-8 text-[#e78a53]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div class="flex gap-3 mt-8">
            ...
            <Button 
              :variant="confirmVariant === 'danger' ? 'danger' : (confirmVariant === 'warning' ? 'warning' : 'primary')"
              @click="handleConfirm"
              class="flex-1"
            >
              {{ confirmText }}
