<template>
  <div v-if="hasError" class="min-h-screen bg-black flex items-center justify-center px-4">
    <div class="max-w-md w-full bg-white/5 rounded-xl p-8 border border-white/10">
      <div class="flex flex-col items-center text-center gap-4">
        ...
        <div class="flex gap-3 w-full">
          <button
            @click="handleReload"
            class="flex-1 px-4 py-2 bg-[#e78a53] hover:bg-[#f59a63] text-white rounded-lg font-medium transition-colors"
          >
            Recargar página
          </button>
          <button
